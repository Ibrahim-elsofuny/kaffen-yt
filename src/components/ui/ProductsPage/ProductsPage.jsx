    ...
    return (
        <div className="product-card-wrapper">
            <div className="product-card w-[40vh] h-[50vh] relative overflow-hidden group flex items-center justify-center flex-col border border-[#b99272] rounded-2xl">
                ...
                <div className="absolute inset-0 rounded-2xl bg-black/50 opacity-0 group-hover:opacity-100 transition flex items-center justify-between px-6">
                    {/* سلة */}
                    <button className="w-10 h-10 flex items-center justify-center text-white hover:text-[#b99272]">
                        <FaShoppingCart size={22} />
                    </button>

                    {/* تفاصيل */}
                    <button onClick={() => onView(item)} className="w-10 h-10 flex items-center justify-center text-white hover:text-[#b99272]">
